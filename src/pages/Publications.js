                    ...
                    <Grid item xs={6} sm={6} md={6}>
                        ...
                        >
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                <h2 style={{ textAlign: 'center' }}>Add Patent</h2>
                                <button onClick={closeModal} style={{ marginLeft: 'auto' }}>X</button>
                            </div>

                            <form onSubmit={handleSubmit}>

                            <div style={{ marginBottom: '10px', display: 'flex', alignItems: 'center' }}>
                                    <label style={{ flex: '0 0 200px' }}>Patent Title :</label>
                                    <input
                                        type="text"
                                        value={patentTitle}
                                ...
                                <div style={{ marginBottom: '10px', display: 'flex', alignItems: 'center' }}>
                                    <label style={{ flex: '0 0 200px' }}>Patent Year :</label>
                                    <input
                                        type="text"
                                        value={patentYear}
                                ...
                                <div style={{ marginBottom: '10px', display: 'flex', alignItems: 'center' }}>
                                    <label style={{ flex: '0 0 200px' }}>Research Lab:

                                        <select value={patentLab} onChange={(e) => setpatentLab(e.target.value)} style={{ flex: '1', maxWidth: '300px' }}>
                                            {centers.map(result => (
                                ...
                                <div style={{ marginBottom: '10px', display: 'flex', alignItems: 'center' }}>
                                    <label style={{ flex: '0 0 200px' }}>Patent Faculty:

                                        <select value={patentHolderName} onChange={(e) => setpatentHolderName(e.target.value)} style={{ flex: '1', maxWidth: '300px' }}>
